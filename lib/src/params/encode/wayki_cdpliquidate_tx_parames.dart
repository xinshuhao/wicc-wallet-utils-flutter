...
class WaykiCdpLiquidateTxParams extends BaseSignTxParams {
  WaykiCdpLiquidateTxModel model;
  WaykiCdpLiquidateTxParams(this.model) : super.fromDictionary(model);
  ...
  Uint8List getSignatureHash(String publicKey,NetworkType netWork) {
    ...
    write.writeString(model.liquidateAssetSymbol);
    write.writeInt(model.sCoinsToLiquidate);
