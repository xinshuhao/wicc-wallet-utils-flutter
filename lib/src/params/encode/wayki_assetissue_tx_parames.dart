...
class WaykiAssetIssueTxParams extends BaseSignTxParams {
  WaykiAssetIssueTxModel model;
  WaykiAssetIssueTxParams(this.model) : super.fromDictionary(model);
