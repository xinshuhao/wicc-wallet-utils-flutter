...
class WaykiUCoinContractTxParams extends BaseSignTxParams {
  WaykiUCoinContractTxModel model;
  WaykiUCoinContractTxParams(this.model) : super.fromDictionary(model);
  ...
  Uint8List getSignatureHash(String publicKey,NetworkType netWork) {
    ...
    write.writeString(model.contract);
    write.writeInt(model.fees);
    write.writeString(model.feeSymbol);
    write.writeInt(model.amount);
