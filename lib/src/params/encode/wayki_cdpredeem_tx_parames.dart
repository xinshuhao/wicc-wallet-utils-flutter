...
class WaykiCdpReeemTxParams extends BaseSignTxParams {
  WaykiCdpRedeemTxModel model;
  WaykiCdpReeemTxParams(this.model) : super.fromDictionary(model);
  ...
  Uint8List getSignatureHash(String publicKey,NetworkType netWork) {
    ...
    write.writeInt(model.sCoinsToRepay);
