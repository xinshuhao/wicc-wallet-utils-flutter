...
class WaykiDexCancelTxParams extends BaseSignTxParams {
  WaykiDexCancelTxModel model;
  WaykiDexCancelTxParams(this.model) : super.fromDictionary(model);
  ...
  Uint8List getSignatureHash(String publicKey,NetworkType netWork) {
    ...
    write.writeBytes(Uint8List.fromList(HEX.decode(model.orderId)));
